...
(async () => {
  ...
  try {
    ...
    await page.fill("input[placeholder=\"e.g. 001 or TEST-1\"]", "101");
    console.log("Typing Access Code...");
    await page.fill("input[type=\"password\"]", "ALPHA1");
    ...
    // Try to find the A option button by looking for "A." text inside a button
